...
#include "../../../heibaiqi/heibqiqi/zhujiemian.h"
...
const QMetaObject ZhuJieMian::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ZhuJieMian.data,
      qt_meta_data_ZhuJieMian,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ZhuJieMian::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZhuJieMian.stringdata0))
        return static_cast<void*>(const_cast< ZhuJieMian*>(this));
